...
<script>
  ...
  gtag('config', 'UA-126119902-1');
    ...
    <script src="../scripts/loc20.js"></script>
    <title>STARSKA | Drop Old Royal Yellow</title>
</head>
<body>
    ...
    <div id="collectionContainer">
        ...
        <div class="gallery" id="e">
            ...
            <div class="galleryIn">
                ...
                <img id="p1img1"src="../images/RoyalYellow/Drop Bag Old Royal Yellow - front.jpg" />
                <img id="p1img2"src="../images/RoyalYellow/Drop Bag Old Royal Yellow - inside.jpg" />

                </div>

                <div class="galleryInRight">
                
                    <div class="smImg r3" id="mT1"><img src="../images/RoyalYellow/Drop Bag Old Royal Yellow - front.jpg" /></div>
                    <div class="smImg r3" id="mT2"><img src="../images/RoyalYellow/Drop Bag Old Royal Yellow - inside.jpg" /></div>
                    <div class="smImg" id="op"><img src="../images/RoyalYellow/Drop Bag Old Royal Yellow - inside.jpg" /></div>
                    <div class="smImg" id="op"><img src="../images/RoyalYellow/Drop Bag Old Royal Yellow - inside.jpg" /></div>
...
<p>DROP BAG</p>
<p>030.001 Old Royal Yellow</p><br/>
...
<p>More Colors</p>
  ...
  <a href="../Poppy/p2.php"><p>030.002 Red Poppie</p></a>
...
if(isset($_GET['saved'])){
    ...
    echo '<form id="noticeBox"  action="r3Mail.php" method="POST">
