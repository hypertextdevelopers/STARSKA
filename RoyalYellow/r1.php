...
<script>
  ...
  gtag('config', 'UA-126119902-1');
    ...
    <script src="../scripts/loc18.js"></script>
    <title>STARSKA | Wave I Royal Yellow</title>
</head>
<body>
    ...
    <div id="collectionContainer">
        ...
        <div class="gallery">
            ...
            <div class="galleryIn">
                ...
                <img id="p1img1"src="../images/RoyalYellow/Wave I Old Royal Yellow - front.jpg" />
                <img id="p1img2"src="../images/RoyalYellow/Wave I Old Royal Yellow - side.jpg" />
                <img id="p1img3"src="../images/RoyalYellow/Hoop Strap Old Royal Yellow.jpg" />

                </div>

                <div class="galleryInRight">
                
                    <div class="smImg r1" id="mT1"><img src="../images/RoyalYellow/Wave I Old Royal Yellow - front.jpg" /></div>
                    <div class="smImg r1" id="mT2"><img src="../images/RoyalYellow/Wave I Old Royal Yellow - side.jpg" /></div>
                    <div class="smImg r1" id="mT3"><img src="../images/RoyalYellow/Hoop Strap Old Royal Yellow.jpg" /></div>
                    <div class="smImg" id="op"><img src="../images/RoyalYellow/Wave I Old Royal Yellow - inside.jpg" /></div>
...
<p>WAVE I</p>
<p>010.001 Old Royal Yellow</p><br/>
...
<p>13H x 21.5W x 9D</p><br />
<p>More Colors</p>
  <a href="../EmeraldGreen/e3.php"><p>010.004 Emmerald Green</p></a>
  <a href="../Poppy/p1.php"><p>010.002 Red Poppie</p></a>
  <a href="../NightBlue/n3.php"><p>010.003 Night Blue</p></a>
  <a href="../CloudyBlue/c1.php"><p>010.005 Cloudy Blue</p></a> 
  <a href="../LightRose/l3.php"><p>010.006 Light Rose</p></a>
...
if(isset($_GET['saved'])){
    ...
    echo '<form id="noticeBox"  action="r1Mail.php" method="POST">
