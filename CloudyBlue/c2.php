...
<head>
    ...
    <script src="../scripts/loc1.js"></script>
...
<script>
  ...
  gtag('config', 'UA-126119902-1');
    ...
    <title>STARSKA | Drop Bag Cloudy Blue</title>
</head>
<body>
    ...
    <div id="collectionContainer">
        ...
        <div class="gallery" id="e">
            ...
            <div class="galleryIn">
                ...
                <img id="p1img1"src="../images/CloudyBlue/Drop Bag Cloudy Blue - front.jpg" />
                <img id="p1img2"src="../images/CloudyBlue/Drop Bag Cloudy Blue - inside.jpg" />

                </div>

                <div class="galleryInRight">
                
                    <div class="smImg c2" id="mT1"><img src="../images/CloudyBlue/Drop Bag Cloudy Blue - front.jpg" /></div>
                    <div class="smImg c2" id="mT2"><img src="../images/CloudyBlue/Drop Bag Cloudy Blue - inside.jpg" /></div>
                    <div class="smImg" id="op"><img src="../images/CloudyBlue/Drop Bag Cloudy Blue - inside.jpg" /></div>
                    <div class="smImg" id="op"><img src="../images/CloudyBlue/Drop Bag Cloudy Blue - inside.jpg" /></div>
...
if(isset($_GET['saved'])){
    ...
    echo '<form id="noticeBox"  action="c2Mail.php" method="POST">
