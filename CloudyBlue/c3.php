...
<head>
    ...
    <script src="../scripts/loc3.js"></script>
...
<script>
  ...
  gtag('config', 'UA-126119902-1');
    ...
    <title>STARSKA | Wave II Cloudy Blue</title>
</head>
<body>
    ...
    <div id="collectionContainer">
        ...
        <div class="gallery">
            ...
            <div class="galleryIn">
                ...
                <img id="p1img1"src="../images/CloudyBlue/Wave II Cloudy Blue - front.jpg" />
                <img id="p1img2"src="../images/CloudyBlue/Wave II Cloudy Blue - side.jpg" />
                <img id="p1img3"src="../images/CloudyBlue/Jewel Strap Light Blue.jpg" />

                </div>

                <div class="galleryInRight">
                
                    <div class="smImg c3" id="mT1"><img src="../images/CloudyBlue/Wave II Cloudy Blue - front.jpg" /></div>
                    <div class="smImg c3" id="mT2"><img src="../images/CloudyBlue/Wave II Cloudy Blue - side.jpg" /></div>
                    <div class="smImg c3" id="mT3"><img src="../images/CloudyBlue/Jewel Strap Light Blue.jpg" /></div>
                    <div class="smImg" id="op"><img src="../images/CloudyBlue/Jewel Strap Light Blue.jpg" /></div>
...
if(isset($_GET['saved'])){
    ...
    echo '<form id="noticeBox"  action="c3Mail.php" method="POST">
