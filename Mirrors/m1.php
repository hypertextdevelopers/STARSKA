...
<head>
    ...
    <script src="../scripts/loc10.js"></script>
...
<script>
  ...
  gtag('config', 'UA-126119902-1');
    ...
    <title>STARSKA | Mirror Mirror I</title>
</head>
<body>
    ...
    <div id="collectionContainer">
        ...
        <div class="gallery" id="b">
            ...
            <div class="galleryIn">
                ...
                <img id="p1img1"src="../images/Mirrors/Mirror Mirror I.jpg" />
                <img id="p1img2"src="../images/Mirrors/Mirror Mirror I (1).jpg" />

                </div>

                <div class="galleryInRight">
                
                    <div class="smImg m1" id="mT1"><img src="../images/Mirrors/Mirror Mirror I.jpg" /></div>
                    <div class="smImg m1" id="mT2"><img src="../images/Mirrors/Mirror Mirror I (1).jpg" /></div>
                    <div class="smImg" id="op"><img src="../images/Mirrors/Mirror Mirror I.jpg" /></div>
                    <div class="smImg" id="op"><img src="../images/Mirrors/Mirror Mirror I.jpg" /></div>
...
<p>Mirror Mirror I</p>
<p>040.007 Emmerald Green / Red Poppie / Light Rose</p><br />
...
if(isset($_GET['saved'])){
    ...
    echo '<form id="noticeBox"  action="m1Mail.php" method="POST">
