...
<body>
    ...
    <div id="collectionContainer">
        ...
        <div id="contactContainer">
           ...
           <div id="contactInLeft">
           
                <p>CONTACT</p>
                <br />
                <br />

                <p class="cIL">GENERAL ENQUIRIES</p>
                <p>studio@starska.co</p>

                <br />
                <br />
                <p class="cIL">DISTRIBUTION ENQUIRES</p>
                <p>sales@starska.co</p>

                <br />
                <br />
                <p class="cIL">PRESS</p>
                <p>press@starska.co</p>

                 <br />
                <br />
                <p class="cIL">OUR STUDIO</p>
                <p>ul. Retoryka 18/10a<br/>31-107 Kraków<br />T: 0048 509 746 784</p>
