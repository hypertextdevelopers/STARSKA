...
<script>
  ...
  gtag('config', 'UA-126119902-1');
    ...
    <script src="../scripts/loc12.js"></script>
    <title>STARSKA | Wave II Night Blue</title>
</head>
<body>
    ...
    <div id="collectionContainer">
        ...
        <div class="gallery">
            ...
            <div class="galleryIn">
                ...
                <img id="p1img1"src="../images/NightBlue/Wave II Night Blue - side.jpg" />
                <img id="p1img2"src="../images/NightBlue/Wave II Night Blue - side (1).jpg" />
                <img id="p1img3"src="../images/NightBlue/Jewel Strap Night Blue.jpg" />

                </div>

                <div class="galleryInRight">
                
                   <div class="smImg n1" id="mT1"><img src="../images/NightBlue/Wave II Night Blue - side.jpg" /></div>
                    <div class="smImg n1" id="mT2"><img src="../images/NightBlue/Wave II Night Blue - side (1).jpg" /></div>
                    <div class="smImg n1" id="mT3"><img src="../images/NightBlue/Jewel Strap Night Blue.jpg" /></div>
                    <div class="smImg" id="op"><img src="../images/NightBlue/Jewel Strap Night Blue.jpg" /></div>
...
if(isset($_GET['saved'])){
    ...
    echo '<form id="noticeBox"  action="n1Mail.php" method="POST">
