...
<script>
  ...
  gtag('config', 'UA-126119902-1');
    ...
    <script src="../scripts/loc13.js"></script>
    <title>STARSKA | Drop Bag Night Blue</title>
</head>
<body>
    ...
    <div id="collectionContainer">
        ...
        <div class="gallery" id="e">
            ...
            <div class="galleryIn">
                ...
                <img id="p1img1"src="../images/NightBlue/Drop Bag Night Blue - front.jpg" />
                <img id="p1img2"src="../images/NightBlue/Drop Bag Night Blue - inside.jpg" />

                </div>

                <div class="galleryInRight">
                
                   <div class="smImg n2" id="mT1"><img src="../images/NightBlue/Drop Bag Night Blue - front.jpg" /></div>
                   <div class="smImg n2" id="mT2"><img src="../images/NightBlue/Drop Bag Night Blue - inside.jpg" /></div>
                    <div class="smImg" id="op"><img src="../images/NightBlue/Drop Bag Night Blue - inside.jpg" /></div>
                    <div class="smImg" id="op"><img src="../images/NightBlue/Drop Bag Night Blue - inside.jpg" /></div>
...
if(isset($_GET['saved'])){
    ...
    echo '<form id="noticeBox"  action="n2Mail.php" method="POST">
