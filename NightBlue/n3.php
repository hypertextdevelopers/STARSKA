...
<script>
  ...
  gtag('config', 'UA-126119902-1');
    ...
    <script src="../scripts/loc14.js"></script>
    <title>STARSKA | Wave I Night Blue</title>
</head>
<body>
    ...
    <div id="collectionContainer">
        ...
        <div class="gallery">
            ...
            <div class="galleryIn">
                ...
                <img id="p1img1"src="../images/NightBlue/Wave I Night Blue - front.jpg" />
                <img id="p1img2"src="../images/NightBlue/Wave I Night Blue - side.jpg" />
                <img id="p1img3"src="../images/NightBlue/Hoop Strap Night Blue.jpg" />

                </div>

                <div class="galleryInRight">
                
                    <div class="smImg n3" id="mT1"><img src="../images/NightBlue/Wave I Night Blue - front.jpg" /></div>
                    <div class="smImg n3" id="mT2"><img src="../images/NightBlue/Wave I Night Blue - side.jpg" /></div>
                    <div class="smImg n3" id="mT3"><img src="../images/NightBlue/Hoop Strap Night Blue.jpg" /></div>
                    <div class="smImg" id="op"><img src="../images/NightBlue/Hoop Strap Night Blue.jpg" /></div>
...
if(isset($_GET['saved'])){
    ...
    echo '<form id="noticeBox"  action="n3Mail.php" method="POST">
