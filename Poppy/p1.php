...
<head>
    ...
    <script src="../scripts/loc15.js"></script>
...
<script>
  ...
  gtag('config', 'UA-126119902-1');
    ...
    <title>STARSKA | Wave I Red Poppy</title>
</head>
<body>
    ...
    <div id="collectionContainer">
        ...
        <div class="gallery">
            ...
            <div class="galleryIn">
                ...
                <img id="p1img1"src="../images/Poppy/Wave I Red Poppy - front.jpg" />
                <img id="p1img2"src="../images/Poppy/Wave I Red Poppy - side.jpg" />
                <img id="p1img3"src="../images/Poppy/Hoop Strap Red Poppy.jpg" />

                </div>

                <div class="galleryInRight">
                
                    <div class="smImg p1" id="mT1"><img src="../images/Poppy/Wave I Red Poppy - front.jpg" /></div>
                    <div class="smImg p1" id="mT2"><img src="../images/Poppy/Wave I Red Poppy - side.jpg" /></div>
                    <div class="smImg p1" id="mT3"><img src="../images/Poppy/Hoop Strap Red Poppy.jpg" /></div>
                    <div class="smImg" id="op"><img src="../images/Poppy/Jewel Strap Red Poppy.jpg" /></div>
...
if(isset($_GET['saved'])){
    ...
    echo '<form id="noticeBox"  action="p1Mail.php" method="POST">
