...
<head>
    ...
    <script src="../scripts/loc17.js"></script>
...
<script>
  ...
  gtag('config', 'UA-126119902-1');
    ...
    <title>STARSKA | Wave II Red Poppy</title>
</head>
<body>
    ...
    <div id="collectionContainer">
        ...
        <div class="gallery">
            ...
            <div class="galleryIn">
                ...
                <img id="p1img1"src="../images/Poppy/WaveRedPoppy3.jpg" />
                <img id="p1img2"src="../images/Poppy/WaveRedPoppy1.jpg" />
                <img id="p1img3"src="../images/Poppy/Jewel Strap Red Poppy.jpg" />

                </div>

                <div class="galleryInRight">
                
                    <div class="smImg p3" id="mT1"><img src="../images/Poppy/WaveRedPoppy3.jpg" /></div>
                    <div class="smImg p3" id="mT2"><img src="../images/Poppy/WaveRedPoppy1.jpg" /></div>
                    <div class="smImg p3" id="mT3"><img src="../images/Poppy/Jewel Strap Red Poppy.jpg" /></div>
                    <div class="smImg" id="op"><img src="../images/Poppy/WaveRedPoppy2.jpg" /></div>
...
if(isset($_GET['saved'])){
    ...
    echo '<form id="noticeBox"  action="p3Mail.php" method="POST">
