...
<head>
    ...
    <script src="../scripts/loc4.js"></script>
...
<script>
  ...
  gtag('config', 'UA-126119902-1');
    ...
    <title>STARSKA | Wave II Emmerald Green</title>
</head>
<body>
    ...
    <div id="collectionContainer">
        ...
        <div class="gallery">
            ...
            <div class="galleryIn">
                ...
                <img id="p1img1"src="../images/EmeraldGreen/Wave II Emmerald Green - side.jpg" />
                <img id="p1img2"src="../images/EmeraldGreen/Wave II Emmerald Green - front.jpg" />
                <img id="p1img3"src="../images/EmeraldGreen/Jewel Strap Emmeral Green.jpg" />

                </div>

                <div class="galleryInRight">
                
                    <div class="smImg em1" id="mT1"><img src="../images/EmeraldGreen/Wave II Emmerald Green - side.jpg" /></div>
                    <div class="smImg em1" id="mT2"><img src="../images/EmeraldGreen/Wave II Emmerald Green - front.jpg" /></div>
                    <div class="smImg em1" id="mT3"><img src="../images/EmeraldGreen/Jewel Strap Emmeral Green.jpg" /></div>
                    <div class="smImg" id="op"><img src="../images/EmeraldGreen/Wave II Emmerald Green - inside.jpg" /></div>
...
<p>More Colors</p>
  ...
  <a href="../RoyalYellow/r2.php"><p>020.001 Old Royal Yellow</p></a>
...
if(isset($_GET['saved'])){
    ...
    echo '<form id="noticeBox"  action="eg1Mail.php" method="POST">
