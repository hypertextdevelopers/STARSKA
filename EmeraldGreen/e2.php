...
<script>
  ...
  gtag('config', 'UA-126119902-1');
    ...
    <script src="../scripts/loc5.js"></script>
    <title>STARSKA | Drop Emmerald Green</title>
</head>
<body>
    ...
    <div id="collectionContainer">
        ...
        <div class="gallery" id="e">
            ...
            <div class="galleryIn">
                ...
                <img id="p1img1"src="../images/EmeraldGreen/Drop Bag Emmerald Green - front.jpg" />
                <img id="p1img2"src="../images/EmeraldGreen/Drop Bag Emmerald Green - inside.jpg" />

                </div>

                <div class="galleryInRight">
                
                   <div class="smImg em2" id="mT1"><img src="../images/EmeraldGreen/Drop Bag Emmerald Green - front.jpg" /></div>
                    <div class="smImg em2" id="mT2"><img src="../images/EmeraldGreen/Drop Bag Emmerald Green - inside.jpg" /></div>
                    <div class="smImg" id="op"><img src="../images/EmeraldGreen/Drop Bag Emmerald Green - inside.jpg" /></div>
                    <div class="smImg" id="op"><img src="../images/EmeraldGreen/Drop Bag Emmerald Green - inside.jpg" /></div>
...
if(isset($_GET['saved'])){
    ...
    echo '<form id="noticeBox"  action="eg2Mail.php" method="POST">
