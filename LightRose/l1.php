...
<head>
    ...
    <script src="../scripts/loc7.js"></script>
...
<script>
  ...
  gtag('config', 'UA-126119902-1');
    ...
    <title>STARSKA | Drop Bag Ligh tRose</title>
</head>
<body>
    ...
    <div id="collectionContainer">
        ...
        <div class="gallery" id="e">
            ...
            <div class="galleryIn">
                ...
                <img id="p1img1"src="../images/LightRose/Drop Bag Light Rose - front.jpg" />
                <img id="p1img2"src="../images/LightRose/Drop Bag Light Rose - inside.jpg" />

                </div>

                <div class="galleryInRight">
                
                   <div class="smImg l1" id="mT1"><img src="../images/LightRose/Drop Bag Light Rose - front.jpg" /></div>
                <div class="smImg l1" id="mT2"><img src="../images/LightRose/Drop Bag Light Rose - inside.jpg" /></div>
                    <div class="smImg" id="op"><img src="../images/LightRose/Drop Bag Light Rose - inside.jpg" /></div>
                    <div class="smImg" id="op"><img src="../images/LightRose/Drop Bag Light Rose - inside.jpg" /></div>
...
if(isset($_GET['saved'])){
    ...
    echo '<form id="noticeBox"  action="l1Mail.php" method="POST">
