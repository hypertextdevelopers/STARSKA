...
<head>
    ...
    <script src="../scripts/loc8.js"></script>
...
<script>
  ...
  gtag('config', 'UA-126119902-1');
    ...
    <title>STARSKA | Wave II Light Rose</title>
</head>
<body>
    ...
    <div id="collectionContainer">
        ...
        <div class="gallery">
            ...
            <div class="galleryIn">
                ...
                <img id="p1img1"src="../images/LightRose/Wave II Light Rose - front.jpg" />
                <img id="p1img2"src="../images/LightRose/Wave II Light Rose - side.jpg" />
                <img id="p1img3"src="../images/LightRose/Jewel Strap Light Rose.jpg" />

                </div>

                <div class="galleryInRight">
                
                    <div class="smImg l2" id="mT1"><img src="../images/LightRose/Wave II Light Rose - front.jpg" /></div>
                    <div class="smImg l2" id="mT2"><img src="../images/LightRose/Wave II Light Rose - side.jpg" /></div>
                     <div class="smImg l2" id="mT3"><img src="../images/LightRose/Jewel Strap Light Rose.jpg" /></div>
                    <div class="smImg" id="op"><img src="../images/LightRose/Jewel Strap Light Rose.jpg" /></div>
...
if(isset($_GET['saved'])){
    ...
    echo '<form id="noticeBox"  action="l2Mail.php" method="POST">
